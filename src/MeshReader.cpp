...

{
  ...
  cout << "Number of boundary element groups............. " << globdat.dom2BndElems.size  () << endl;
  if (globdat.is3D){
  cout << "Three dimensional mesh is being considered\n";
  }
  cout << "Are quadratic elements used................??? " << globdat.isQuadratic << endl;
  cout << "Is hydraulic fracture option on............??? " << globdat.isHydraulic << endl;
